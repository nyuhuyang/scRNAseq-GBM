...
object@meta.data = readRDS(file = "data/GBM_PBMC_3_20210908_metadata.rds")
...
saveRDS(sweep.res_list,file = "output/GBM_PBMC_3_20210908_sweep.res_list.rds")
sweep.res_list = readRDS(file = "output/GBM_PBMC_3_20210908_sweep.res_list.rds")
...
saveRDS(object,file=paste0("data/GBM_PBMC_3_20210908.rds"))
