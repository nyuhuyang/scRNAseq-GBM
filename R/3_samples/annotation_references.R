...
counts <- Read10X(data.dir = "data/annotation_references/filtered_feature_bc_matrix_MouseTransplantedGBM/filtered_gene_bc_matrices/mm10")
meta.data = read.csv("data/annotation_references/annot_Mouse_GBM_Full.csv")
